  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
      <Link href="/schedule" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        ...
        <span className="text-sm font-semibold text-gray-700 text-center">Lịch học</span>
      ...
      <Link href="/review/jlpt" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        <span className="text-3xl mb-2">🈁</span>
        <span className="text-sm font-semibold text-gray-700 text-center">Ôn Kanji</span>
      ...
      <Link href="/quiz?mode=import" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        ...
        <span className="text-sm font-semibold text-gray-700 text-center">TN Kanji theo nghĩa</span>
      </Link>
      <Link href="/schedule/quiz" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        <span className="text-3xl mb-2">📝</span>
        <span className="text-sm font-semibold text-gray-700 text-center">Quiz Từ vựng</span>
      </Link>
      {!restrictUser && <>
      <Link href="/lessons" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        <span className="text-3xl mb-2">📖</span>
        <span className="text-sm font-semibold text-gray-700 text-center">Bài học</span>
      </Link>
      <Link href="/kana" className="flex flex-col items-center justify-center py-6 rounded-xl border border-gray-100 bg-white hover:border-[#6C63FF]/30 hover:shadow-md transition-all">
        <span className="text-3xl mb-2">🔤</span>
        <span className="text-sm font-semibold text-gray-700 text-center">Kana</span>
      </Link>
      </>}
    </div>
  );
